                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="name" id="name"
                                                                class="form-control" value="{{Auth::guard('admin')->user()->name}}"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="username" id="username"
                                                                class="form-control" value="{{Auth::guard('admin')->user()->username}}"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div>
                                                    <button type="button" class="btn btn-warning" data-toggle="modal"
                                                        data-target="#editu" data-usr_id="{{Auth::guard('admin')->user()->id }}"
                                                        data-nama="{{Auth::guard('admin')->user()->name}}" data-uname="{{Auth::guard('admin')->user()->username }}" 
